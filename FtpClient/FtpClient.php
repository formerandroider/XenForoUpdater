 ...
 */
class LiamW_XenForoUpdater_FtpClient_FtpClient implements Countable
{
	/**
	 ...
	 *
	 * @var LiamW_XenForoUpdater_FtpClient_FtpWrapper
	 */
	private $ftp;
	 ...
	 *
	 * @throws LiamW_XenForoUpdater_FtpClient_FtpException  If ftp extension is not loaded.
	 */
	public function __construct($connection = null)
	{
		if (!extension_loaded('ftp'))
		{
			throw new LiamW_XenForoUpdater_FtpClient_FtpException('FTP extension is not loaded!');
		}
		...
		$this->setWrapper(new LiamW_XenForoUpdater_FtpClient_FtpWrapper($this->conn));
	}
	 ...
	 *
	 * @return mixed
	 * @throws LiamW_XenForoUpdater_FtpClient_FtpException When the function is not valid
	 */
	 ...
	 *
	 * @return LiamW_XenForoUpdater_FtpClient_FtpClient
	 */
	 ...
	 *
	 * @return LiamW_XenForoUpdater_FtpClient_FTPClient
	 * @throws LiamW_XenForoUpdater_FtpClient_FtpException If unable to connect
	 */
	public function connect($host, $ssl = false, $port = 21, $timeout = 90)
	{
		...
		if (!$this->conn)
		{
			throw new LiamW_XenForoUpdater_FtpClient_FtpException('Unable to connect');
		}
	 ...
	 * Get the wrapper
	 *
	 * @return LiamW_XenForoUpdater_FtpClient_FtpWrapper
	 */
	 ...
	 *
	 * @return LiamW_XenForoUpdater_FtpClient_FTPClient If the login is incorrect
	 */
	public function login($username = 'anonymous', $password = '')
	{
		...
		if ($result === false)
		{
			throw new LiamW_XenForoUpdater_FtpClient_FtpException('Login incorrect');
		}
	...
	public function up()
	{
		...
		if ($result === false)
		{
			throw new LiamW_XenForoUpdater_FtpClient_FtpException('Unable to get parent folder');
		}
	 ...
	 *
	 * @return array
	 * @throws LiamW_XenForoUpdater_FtpClient_FtpException If unable to list the directory
	 */
	public function nlist($directory = '.', $recursive = false, $filter = 'sort')
	{
		if (!$this->isDir($directory))
		{
			throw new LiamW_XenForoUpdater_FtpClient_FtpException('"' . $directory . '" is not a directory');
		}
		...
		if ($files === false)
		{
			throw new LiamW_XenForoUpdater_FtpClient_FtpException('Unable to list directory');
		}
	 ...
	 *
	 * @return bool
	 * @throws LiamW_XenForoUpdater_FtpClient_FtpException If unable to list the directory to remove
	 */
	...
	public function isDir($directory)
	{
		...
		if ($pwd === false)
		{
			throw new LiamW_XenForoUpdater_FtpClient_FtpException('Unable to resolve the current directory');
		}
	 ...
	 *
	 * @return LiamW_XenForoUpdater_FtpClient_FtpClient
	 * @throws LiamW_XenForoUpdater_FtpClient_FtpException When the transfer fails
	 */
	public function putFromString($remote_file, $content)
	{
		...
		throw new LiamW_XenForoUpdater_FtpClient_FtpException('Unable to put the file "' . $remote_file . '"');
	}
	...
	public function putFromPath($local_file)
	{
		...
		throw new LiamW_XenForoUpdater_FtpClient_FtpException(
	 ...
	 *
	 * @return array
	 * @throws LiamW_XenForoUpdater_FtpClient_FtpException
	 */
	...
	public function rawToType($permission)
	{
		...
		{
			throw new LiamW_XenForoUpdater_FtpClient_FtpException('The "$permission" argument must be a string, "'
	 ...
	 *
	 * @param  LiamW_XenForoUpdater_FtpClient_FtpWrapper $wrapper
	 *
	 * @return LiamW_XenForoUpdater_FtpClient_FtpClient
	 */
	protected function setWrapper(LiamW_XenForoUpdater_FtpClient_FtpWrapper $wrapper)
	{
		$this->ftp = $wrapper;
